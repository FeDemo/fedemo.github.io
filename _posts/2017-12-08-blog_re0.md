...
>最后,[这是我的博客 fedemo.top](http://fedemo.top/)
...
在这过程中也踩过不少坑,总算把我的个人博客[fedemo.top](http://fedemo.top/)给搭出来了  
...
当然,如果觉得我现在用的模板比较好看也可以直接[**fork**](https://github.com/FeDemo/fedemo.github.io)我的这个[项目](https://github.com/FeDemo/fedemo.github.io),然后点击**setting**修改项目名称为自己的名字.  
...
更加详细的介绍可以看下官方的 [中文文档](https://github.com/gitalk/gitalk/blob/master/readme-cn.md)
和这篇[文章](http://qiubaiying.top/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)
...
本搜索插件来自[小胖轩](https://github.com/androiddevelop/jekyll-search),效果见右下角或者连续按两下`ctrl`    
具体细节可以看下他的[项目](https://github.com/androiddevelop/jekyll-search)
```
#如果不需要可以注释掉
#search plugins
...
对于轻车熟路的程序猿来说，使用git管理在本地编写(推荐使用[Atom初体验](http://fedemo.top/2017/11/26/atom_first/))会更加方便,这里就说说如何在github网页上编写文章.
> 创建文件   
...
我的话是在百度云买的域名(当时由于在公司,路由屏蔽了淘宝,所以阿里云的账号登不上去) ,我的fedemo.top首年只要一块钱
